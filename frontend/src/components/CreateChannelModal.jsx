...
const CreateChannelModal = ({ onClose }) => {
  ...
  //fetch users for modal component
  useEffect(() => {
    const fetchUsers = async () => {
      ...
      try {
        ...
        Sentry.captureException(error, {
          tags: { component: "Create Channel Modal" },
  ...
  //select every user if channel is public
  useEffect(() => {
  ...
  //toogle member selection for checkbox
  ...
  const handleFormSubmit = async (e) => {
    ...
    setError("");
    try {
      // make all channel names lowercase and dash seprated
      ...
      if (channelType === "private") {
        ...
        channelData.visability = "private";
      } else {
        channelData.visability = "public";
        channelData.discoverable = true;
      }

      const channel = client.channel("messaging", channelId, channelData);

      //watches for real time update
      await channel.watch();
